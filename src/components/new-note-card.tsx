          ...
          <form className="flex flex-1 flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300outline-none font-medium hover:text-slate-400"
              >
